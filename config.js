...
global.namebot = 'ᴹᴿ᭄ IlhamModsTzy ×፝֟͜×-𝑀𝐷'
global.wm = '© IlhamMods-𝑀𝐷 | IlhamMdos'
...
global.titlebot = `IlhamModsTzy ×፝֟͜×`
global.stickpack = 'IlhamModsTzy ×፝֟͜×'
global.gcname = 'IlhamModsTzy ×፝֟͜×'
global.nameown1= 'IlhamModsTzy ×፝֟͜×'
global.nameown2 = 'IlhamModsTzy ×፝֟͜×'
global.nameown3 = 'IlhamModsTzy ×፝֟͜×'
global.packname2 = 'IlhamModsTzy ×፝֟͜×'
global.stickauth = `© IlhamModsTzy ×፝֟͜×-𝑀𝐷`
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown = 'IlhamModsTzy ×፝֟͜×-𝑀𝐷'
